...
class User(AbstractUser):
    ...
    address_line_2 = models.CharField("Address Line 2", max_length=255, blank=True, help_text="Optional")
    city = models.CharField("City", max_length=100, blank=True)
    state = models.CharField("State or Region", max_length=100, blank=True)
